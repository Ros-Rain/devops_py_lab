...
tmpl_slides_file = os.path.abspath(home_abspath + "/../tmpl/slides_ver_2.md")
out_md_file = os.path.abspath(home_abspath + "/../out/slides_ver_2.md")
out_pptx_file = os.path.abspath(home_abspath + "/../out/slides_ver_2.pptx")
